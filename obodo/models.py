...
class RequestOfferPost(models.Model):
    ...
    post_image = ProcessedImageField(upload_to='images', default='default.jpeg',
...
class Event(models.Model):
    ...
    event_pic = ProcessedImageField(upload_to='images', default='default.jpeg',
                                      processors=[ResizeToFill(300, 200)],
                                      format='JPEG',
                                      options={'quality': 60})
...
class Organization(models.Model):
    ...
    picture = ProcessedImageField(upload_to='images', default='default.jpeg',
                                      processors=[ResizeToFill(300, 200)],
                                      format='JPEG',
                                      options={'quality': 60})
